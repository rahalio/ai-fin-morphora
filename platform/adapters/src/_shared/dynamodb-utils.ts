 ...
 *
 * @returns The core table name (e.g., "morphora-core-dev")
 ...
 *
 * @returns The base table name (e.g., "morphora-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "morphora-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "morphora-app-realtime-dev")
