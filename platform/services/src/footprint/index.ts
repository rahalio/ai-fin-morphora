/**
 * Footprint Services - Application Layer Export
 *
...
/**
 * Footprint Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for footprint domain.
 */
