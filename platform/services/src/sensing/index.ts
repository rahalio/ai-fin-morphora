/**
 * Sensing Services - Application Layer Export
 *
...
/**
 * Sensing Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for sensing domain.
 */
